...
const requestWriteReview = (data, callback, errorCallback) => {
  axios
    ...
    .then((res) => {
      ...
      axios
        .post(`http://j5a404.p.ssafy.io:8082/boardgamerec/update/gd/${userId}`)
        .then(() => {
...
const BoardgameApi = {
  requestGameInfo: (data, callback, errorCallback) =>
    requestGameInfo(data, callback, errorCallback),
  requestGameSearch: (data, callback, errorCallback) =>
    requestGameSearch(data, callback, errorCallback),
  requestGameReview: (data, callback, errorCallback) =>
    requestGameReview(data, callback, errorCallback),
  requestWriteReview: (data, callback, errorCallback) =>
    requestWriteReview(data, callback, errorCallback),
  requestDeleteReview: (data, callback, errorCallback) =>
    requestDeleteReview(data, callback, errorCallback),
  requestDeleteQna: (data, callback, errorCallback) =>
    requestDeleteQna(data, callback, errorCallback),
  requestGameQuestion: (data, callback, errorCallback) =>
    requestGameQuestion(data, callback, errorCallback),
  requestGameQuestionReply: (data, callback, errorCallback) =>
    requestGameQuestionReply(data, callback, errorCallback),
  requestGameWriteQuestion: (data, callback, errorCallback) =>
    requestGameWriteQuestion(data, callback, errorCallback),
  requestGameQuestionWriteReply: (data, callback, errorCallback) =>
    requestGameQuestionWriteReply(data, callback, errorCallback),
  requestGameBookmark: (data, callback, errorCallback) =>
    requestGameBookmark(data, callback, errorCallback),
  likeAnswer: (data, callback, errorCallback) =>
    likeAnswer(data, callback, errorCallback),
};
